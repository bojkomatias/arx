...
Dropdown.Content = ({
  ...
  <div
    {...props}
    class={cx(
      "dropdown bg-card ring-border absolute z-10 w-64 rounded-xl p-2 shadow ring-1",
...
Dropdown.Item = ({
  ...
  <Component
    ...
    class={buttonStyles({
      class: cx(
        "text-muted-foreground hover:text-foreground w-full justify-between font-normal",
        props.class,
      ),
      intent: props.intent,
      size: props.size,
...
Dropdown.Separator = () => <div class="border-border my-1 h-0 border-t" />;
